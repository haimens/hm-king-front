...
export const sendEmailToLord = (realm_token, lord_token, name, username, img, company_name) => async dispatch => {
  try {
                ...
                <tr>
                  <td align="center" valign="top" style="padding: 36px 24px;">
                    <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                      <img src=${img} alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                    </a>
                  </td>
                </tr>
              </table>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <p style="margin: 0;">Welcome to ${company_name}. We have received your registration. Your Username is <span class="font-bold">${username}</span> Thank you again for registration. If you have any questions, please let us know!
              </td>
            </tr>
            <!-- end copy -->
    ...
    await startLoader(dispatch);
    await callApi(`email/send/lord/${realm_token}/${lord_token}`, "POST", {
