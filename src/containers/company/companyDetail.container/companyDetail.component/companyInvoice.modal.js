...
class CompanyInvoice extends Component {
  ...
  handleAddingInvoiceInACompany = () => {
    ...
    if (amount !== "" && !isNaN(amount)) {
      ...
      this.props.createAInvoiceInCompany(realm_token, { amount: amount * 100 }, msg);
      this.handleClose();
    } else {
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Thank you for using our services. Your total invoice is ${parseAmount(
                this.props.sum,
                2
              )}. Thanks! </td>
          </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                  <p style="margin: 0;">You received this email because of your invoice. If you didn't know this invoice you can safely delete this email.</p>
                </td>
              </tr>
              <!-- end permission -->
