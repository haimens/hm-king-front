...
export default function CompanyEmailListItem(props) {
  ...
  const { sendgrid_api_key, sendgrid_from_email, email_resource_token } = props.parentProps;
  return (
    <tr className="border-bottom">
      ...
      <td className="items-height align-middle" data-label="SendGrid Access Token">
